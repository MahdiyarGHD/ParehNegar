...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContentContract', function() {
      beforeEach(function() {
        instance = new ParehNegarwebApi.ContentContract();
      });

      it('should create an instance of ContentContract', function() {
        // TODO: update the code to test ContentContract
        expect(instance).to.be.a(ParehNegarwebApi.ContentContract);
      });
