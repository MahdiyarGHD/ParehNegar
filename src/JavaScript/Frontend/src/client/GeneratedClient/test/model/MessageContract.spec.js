...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageContract', function() {
      beforeEach(function() {
        instance = new ParehNegarwebApi.MessageContract();
      });

      it('should create an instance of MessageContract', function() {
        // TODO: update the code to test MessageContract
        expect(instance).to.be.a(ParehNegarwebApi.MessageContract);
      });
